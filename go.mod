module github.com/devicechain-io/dcctl
...
require (
	...
	github.com/devicechain-io/dc-event-management v0.0.0
...
replace github.com/devicechain-io/dc-event-management v0.0.0 => ../dc-event-management
